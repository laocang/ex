...
////		byte[] result = decrypt1(rawKey, encrypted);
//		return result;
//		}
...
//		}
	    ...
	    public static byte[] encrypt(byte[] content) {
	        ...
	        try {
	            ...
	            SecretKeySpec key = createKey("abc123123456456789ad45645dadfc12");
		...
		public static byte[] decrypt(byte[] encrypted) throws Exception {
		   SecretKeySpec skeySpec = createKey("abc123123456456789ad45645dadfc12");
		Cipher cipher = Cipher.getInstance("AES/ECB/PKCS5Padding");
