var Paint = (function () {
    return {
        ...
        load: function (container) {
            ...
            this.cxt.lineWidth = 8; //线条的宽度 
            this.iptClear = this.$("clear");
            this.iptPencil = this.$("pencil");
...
//            };
            /*设置画笔*/
//            this.iptPencil.onclick = function () {
//                t.$("eraser").style.color = "Black";
//                t.$("pencil").style.color = "red"; 
//                t.cxt.save();
//                t.cxt.strokeStyle = t.color[0];
//                t.storageColor = t.color[0];
...
//                t.isEraser = true;
//                t.$("eraser").style.color = "red";
//                t.$("pencil").style.color = "Black";
...
//            };
        ...
        paint:function(){
        	...
        	this.storageColor = this.color[0];
